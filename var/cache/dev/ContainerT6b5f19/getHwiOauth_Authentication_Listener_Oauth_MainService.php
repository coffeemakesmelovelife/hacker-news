...
$d->setOptions(array('login_path' => '/login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
...
$instance->setCheckPaths(array(0 => '/login/check-facebook'));
