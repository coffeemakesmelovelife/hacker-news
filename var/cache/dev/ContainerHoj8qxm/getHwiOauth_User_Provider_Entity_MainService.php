...
include_once $this->targetDirs[3].'/src/AppBundle/Repository/UserRepository.php';

return $this->services['hwi_oauth.user.provider.entity.main'] = ${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->load(__DIR__.'/getDoctrine_Orm_DefaultEntityManagerService.php')) && false ?: '_'}->getRepository('AppBundle\\Entity\\User');
